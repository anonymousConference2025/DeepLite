...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path','-mp',default='./tmp_lenet5.h5', help='model path')
    parser.add_argument('--config_path', '-cp',default='./config_lenet_Adam.pkl', help='training configurations path') 
