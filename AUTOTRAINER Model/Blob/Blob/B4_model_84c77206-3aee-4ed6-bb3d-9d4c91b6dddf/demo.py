...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path','-mp',default='./model_84c77206.h5', help='model path')
    parser.add_argument('--config_path', '-cp',default='./config_SGD_c9a754a0.pkl', help='training configurations path') 
