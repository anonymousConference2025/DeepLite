...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path','-mp',default='./model_mi_al_16_f09b5b8a.h5', help='model path')
    parser.add_argument('--config_path', '-cp',default='./config_Adadelta_ce0dfd3f.pkl', help='training configurations path') 
