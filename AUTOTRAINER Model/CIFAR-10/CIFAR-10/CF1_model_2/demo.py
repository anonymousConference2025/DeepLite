...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path','-mp',default='./tmp_lenet5_cifar.h5', help='model path')
    parser.add_argument('--config_path', '-cp',default='./config_lenet-cifar10_adam.pkl', help='training configurations path') 
