...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path','-mp',default='./model_mi_al_22_a5c68f2e.h5', help='model path')
    parser.add_argument('--config_path', '-cp',default='./config_Adamax_7706d823.pkl', help='training configurations path') 
