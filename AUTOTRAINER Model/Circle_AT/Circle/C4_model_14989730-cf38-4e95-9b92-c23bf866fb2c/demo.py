...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path','-mp',default='./model_14989730.h5', help='model path')
    parser.add_argument('--config_path', '-cp',default='./config_simplednn_adam.pkl', help='training configurations path') 
